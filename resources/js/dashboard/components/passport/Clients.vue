...
tabindex="-1" @click="showCreateClientForm">
      ...
      <div class="card-body">
        ...
        <table v-if="clients.length > 0" class="table table-borderless mb-0">
          <thead>
            <tr>
              <th>Client ID</th>
              <th>Name</th>
...
type="text" class="form-control"
                         v-model="createForm.name" @keyup.enter="store">
...
class="form-control" name="redirect"
                         v-model="createForm.redirect" @keyup.enter="store">
...
id="edit-client-name" 
type="text" class="form-control"
                         v-model="editForm.name" @keyup.enter="update">
...
type="text" 
class="form-control" name="redirect"
                         v-model="editForm.redirect" @keyup.enter="update">
